...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            sync: {
                src: ['src/aerogear.core.js', 'external/diff-match-patch/diff_match_patch_uncompressed.js', 'src/sync/aerogear.sync-engine.js', 'src/sync/aerogear.sync-client.js'],
    ...
    grunt.registerTask('sync', ['concat:sync']);
